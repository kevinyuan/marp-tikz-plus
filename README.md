...
Also available for VS Code: [TikZJax for VS Code](https://github.com/kevinyuan/vscode-tikz) — [VS Marketplace](https://marketplace.visualstudio.com/items?itemName=kevinyuan.vscode-tikzjax) · [Open VSX](https://open-vsx.org/extension/kevinyuan/vscode-tikzjax)
